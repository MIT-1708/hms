...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-hms-secret-key-change-in-production')
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = os.environ.get('EMAIL_HOST_USER', 'smart.care.2025.01@gmail.com')
EMAIL_HOST_PASSWORD = os.environ.get('EMAIL_HOST_PASSWORD', 'soip vlre szcg lmwu')
